...
def decode_binary_string(binary_string, packet_version_total=0):
    ...
    if len(binary_string) == 0:
        return packet_version_total, binary_string
    ...
    if type_id != 4:
        ...
        if length_type_id == 0:
            ...
            while elapsed_length <= sub_packet_length:
                packet_version_total, next_binary_string = decode_binary_string(next_binary_string, packet_version_total)
                elapsed_length += len(binary_string) - len(next_binary_string)
            print("finished len loop")
            return packet_version_total, next_binary_string
